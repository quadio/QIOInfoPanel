...
// 
//  Based on work originally creatd created by Mugunth on 25/04/11.
...
#import "QIOInfoPanel.h"
#import <QuartzCore/QuartzCore.h>

// Private Methods

@interface QIOInfoPanel ()

@property (nonatomic, assign) QIOInfoPanelType type;

+ (QIOInfoPanel*) infoPanel;
...
+ (QIOInfoPanel *)showPanelInView:(UIView *)view type:(QIOInfoPanelType)type title:(NSString *)title subtitle:(NSString *)subtitle {
    return [self showPanelInView:view type:type title:title subtitle:subtitle hideAfter:-1];
}

+(QIOInfoPanel *)showPanelInView:(UIView *)view type:(QIOInfoPanelType)type title:(NSString *)title subtitle:(NSString *)subtitle hideAfter:(NSTimeInterval)interval {    
    QIOInfoPanel *panel = [QIOInfoPanel infoPanel];
...
+ (QIOInfoPanel *)showPanelInWindow:(UIWindow *)window type:(QIOInfoPanelType)type title:(NSString *)title subtitle:(NSString *)subtitle {
    return [self showPanelInWindow:window type:type title:title subtitle:subtitle hideAfter:-1];
}

+(QIOInfoPanel *)showPanelInWindow:(UIWindow *)window type:(QIOInfoPanelType)type title:(NSString *)title subtitle:(NSString *)subtitle hideAfter:(NSTimeInterval)interval {
    QIOInfoPanel *panel = [self showPanelInView:window type:type title:title subtitle:subtitle hideAfter:interval];
...
+(QIOInfoPanel *)infoPanel {
    QIOInfoPanel *panel =  (QIOInfoPanel*) [[[UINib nibWithNibName:@"QIOInfoPanel" bundle:nil] 
